# 【WeBank】Linkis 0.x 和 1.x 的区别

摘自 [github](https://github.com/WeBankFinTech/Linkis/wiki/Linkis1.0%E4%B8%8ELinkis0.X%E7%9A%84%E5%8C%BA%E5%88%AB%E7%AE%80%E8%BF%B0)
...
![](https://github.com/sherlock0116/Linkis/blob/dev-1.1.0/images/zh_CN/Linkis1.0/installation/Linkis0.X-services-list.png?raw=true)

Linkis1.0 微服务列表如下：

![](https://github.com/sherlock0116/Linkis/blob/dev-1.1.0/images/zh_CN/Linkis1.0/installation/Linkis1.0-services-list.png?raw=true)

Linkis1.0 将服务分为了三类服务：计算治理（英文缩写CG）/微服务治理（MG）/公共增强服务(PS)。其中：
...
![](https://github.com/sherlock0116/Linkis/blob/dev-1.1.0/images/zh_CN/Linkis1.0/architecture/Linkis0.X-NewEngine-architecture.png?raw=true)

   以下为Linkis1.0.0，实现一个新引擎，用户需实现的接口和类：

​	![](https://github.com/sherlock0116/Linkis/blob/dev-1.1.0/images/zh_CN/Linkis1.0/architecture/Linkis1.0-NewEngine-architecture.png?raw=true)
...
![](https://github.com/sherlock0116/Linkis/blob/dev-1.1.0/images/zh_CN/Linkis1.0/architecture/Linkis1.0-newEngine-initialization.png?raw=true)
...
![](https://github.com/sherlock0116/Linkis/blob/dev-1.1.0/images/zh_CN/Linkis1.0/architecture/Linkis1.0-architecture.png?raw=true)